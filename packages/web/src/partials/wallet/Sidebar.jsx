        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('accounts') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/wallet/accounts"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                    pathname.includes('accounts') && 'hover:text-slate-200'
                  }`}
                >
            ...
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3 mt-4">
              <span className="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">
                •••
              </span>
