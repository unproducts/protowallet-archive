...
export default function NewRecurringTransactionForm() {
  ...
  const [recursionEndType, setRecursionEndType] = useState({ value: 'count', label: 'count' });
    ...
    <div className="px-5 py-4">
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <DatepickerSingle align={'middle'} setSelectedStartDate={setStartDate} />
        </div>
        {/* Start */}
        <div>
        ...
        {repeat ? (
          <div>
            ...
            {recursionEndType.value === 'date' && <DatepickerSingle />}
            <Select
